...
//                                                          ImGui_ImplVulkan_AddTexture( CreateBasicSampler(), dynamic_cast<const VulkanTexture*>( texture )->GetImage().GetView(), VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL ) ) };
//
//             if ( success ) {
...
//     }
//
//     static auto UpdateMaterialTexture( Material& standardMat, TextureType mapType ) -> void {
//         // Load a new texture
//         FileSystem& fileSystem{ ServiceInitializer::GetSystem<FileSystem>() };
...
//                 UpdateMaterialTexture( standardMat, TextureType::TEXTURE_2D_DIFFUSE );
//             }
//
...
//                     standardMat.RemoveMap( TextureType::TEXTURE_2D_DIFFUSE );
//                 }
//
//                 ImGui::EndTable();
//             }
...
//                 UpdateMaterialTexture( standardMat, TextureType::TEXTURE_2D_SPECULAR );
//             }
//
...
//                 ImGuiUtils::ImGuiScopedStyleVar innerSpacing{ ImGuiStyleVar_FramePadding, ImVec2{ 5.0f, 5.0f } };
//                 if (ImGui::Button( "Remove Texture" )) {
//                     standardMat.RemoveMap( TextureType::TEXTURE_2D_SPECULAR );
//                 }
//
//                 if ( ImGui::IsItemHovered() ) {
//                     ImGui::SetMouseCursor( ImGuiMouseCursor_Hand );
...
//             if (ImGuiUtils::PushImageButton( diffuseMap->GetID().Get(), GetDescriptorSetById( diffuseMap ), ImVec2{ 64, 64 } ) ) {
//                 UpdateMaterialTexture( material, TextureType::TEXTURE_2D_DIFFUSE );
//             }
//
...
//
//                 if (ImGui::Button( "Remove Texture" )) {
//                     material.RemoveMap( TextureType::TEXTURE_2D_DIFFUSE );
//                 }
//
//                 ImGui::EndTable();
//             }
...
//             UpdateMaterialTexture( material, TextureType::TEXTURE_2D_METALLIC );
//         }
//
...
//
//             if ( ImGui::Button( "Remove Texture" ) ) {
//                 material.RemoveMap( TextureType::TEXTURE_2D_METALLIC );
//             }
//
//             if ( ImGui::IsItemHovered() ) {
//                 ImGui::SetMouseCursor( ImGuiMouseCursor_Hand );
...
//             UpdateMaterialTexture( material, TextureType::TEXTURE_2D_NORMAL );
//         }
//
...
//             ImGuiUtils::ImGuiScopedStyleVar innerSpacing{ ImGuiStyleVar_FramePadding, ImVec2{ 5.0f, 5.0f } };
//             if ( ImGui::Button( "Remove Texture" ) ) {
//                 material.RemoveMap( TextureType::TEXTURE_2D_NORMAL );
//             }
//
//             if ( ImGui::IsItemHovered() ) {
//                 ImGui::SetMouseCursor( ImGuiMouseCursor_Hand );
...
//             UpdateMaterialTexture( material, TextureType::TEXTURE_2D_ROUGHNESS );
//         }
//
...
//
//             if ( ImGui::Button( "Remove Texture" ) ) {
//                 material.RemoveMap( TextureType::TEXTURE_2D_ROUGHNESS );
//             }
//
//             if ( ImGui::IsItemHovered() ) {
//                 ImGui::SetMouseCursor( ImGuiMouseCursor_Hand );
...
//
//         if ( ImGuiUtils::PushImageButton( specularMap->GetID().Get(), GetDescriptorSetById( specularMap ), ImVec2{ 64, 64 } ) ) {
//             UpdateMaterialTexture( material, TextureType::TEXTURE_2D_AMBIENT_OCCLUSION );
//         }
//
...
//
//             if ( ImGui::Button( "Remove Texture" ) ) {
//                 material.RemoveMap( TextureType::TEXTURE_2D_AMBIENT_OCCLUSION );
//             }
//
//             if ( ImGui::IsItemHovered() ) {
//                 ImGui::SetMouseCursor( ImGuiMouseCursor_Hand );
...
//                 case TextureType::TEXTURE_2D_DIFFUSE:
//                     diffuseIndex = index;
//                     break;
//                 case TextureType::TEXTURE_2D_SPECULAR:
//                     specularIndex = index;
//                     break;
//                 case TextureType::TEXTURE_2D_EMISSIVE:
//                     emissionIndex = index;
//                     break;
//                 case TextureType::TEXTURE_2D_NORMAL:
//                     normalIndex = index;
//                     break;
//                 case TextureType::TEXTURE_2D_ROUGHNESS:
//                     roughnessIndex = index;
//                     break;
//                 case TextureType::TEXTURE_2D_METALLIC:
//                     metallicIndex = index;
//                     break;
//                 case TextureType::TEXTURE_2D_AMBIENT_OCCLUSION:
//                     aoIndex = index;
//                     break;
//
//                 case TextureType::TEXTURE_2D_INVALID:
//                 case TextureType::TEXTURE_2D_COUNT:
//                 default:
...
//
//         FileSystem& fileSystem{ ServiceInitializer::GetSystem<FileSystem>() };
//         RenderSystem& renderSystem{ ServiceInitializer::GetSystem<RenderSystem>() };
//         AssetsSystem& assetsSystem{ ServiceInitializer::GetSystem<AssetsSystem>() };
//
...
//
//             if ( !path.empty() ) {
//                 const ModelLoadDescription modelLoadInfo{
//                     .Path = path,
