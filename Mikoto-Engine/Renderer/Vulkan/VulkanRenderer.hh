...
namespace Mikoto {
    ...
    private:
         ...
         * */
        auto PrepareDeferredAttachments() -> void;

        auto CreateDeferredSampler() -> void;
        auto CreateDeferredRenderPass() -> void;
        auto CreateDeferredFrameBuffer() -> void;

        auto InitializeDeferredPipeline() -> void;

        static auto CreateFrameBufferAttachment(FrameBufferAttachment& frameBufferAttachment, const FramebufferAttachmentCreateInfo& framebufferAttachmentCreateInfo) -> void;
    ...
    private:
        ...
        // [Deferred]
        // Single framebuffer with three attachments (color, normals and position)
        VulkanFrameBuffer m_DeferredFrameBuffer{};

        FrameBufferAttachment m_AlbedoDeferredAttachment{};
        FrameBufferAttachment m_NormalsDeferredAttachment{};
        FrameBufferAttachment m_PositionsDeferredAttachment{};
        FrameBufferAttachment m_DepthDeferredAttachment{};

        VkRenderPass m_DeferredRenderPass{};
        VkSampler m_DeferredSampler{};
