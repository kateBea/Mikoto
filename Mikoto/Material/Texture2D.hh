    ...
    */
    ...
    protected:
        ...
        Texture2D( const Int32 width, const Int32 height, const Int32 channels, Byte* data,
                   const ResourceUsageType usage, TextureFormat format = TextureFormat::RGBA8_UNORM, UInt32 mipLevelCount = 1,
                   TextureUsage textureUsage = TextureUsage::NORMAL, MapType mapType = MapType::UNDEFINED_TEXTURE)
            : Texture{ TextureType::TEXTURE_2D, format, width, height, channels, usage, textureUsage, mipLevelCount }, m_Data{ data }, m_MapType{ mapType }
        {}
