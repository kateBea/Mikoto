...
namespace Mikoto {
    ...
    private:
        ...
        static constexpr auto GetSizeFromShaderType(ShaderDataType type) -> UInt32_T {
            switch (type) {
                ...
                default:
                    MKT_CORE_LOGGER_ERROR(false, "Invalid shader data type");
            }
    ...
    public:
        ...
        auto operator[]( const UInt32_T index) -> BufferElement& { return m_Items[index]; }
        auto operator[]( const UInt32_T index) const -> const BufferElement& { return m_Items[index]; }
