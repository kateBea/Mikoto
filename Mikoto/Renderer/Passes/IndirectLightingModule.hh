...
#ifndef MIKOTO_INDIRECT_LIGHTING_MODULE_HH
#define MIKOTO_INDIRECT_LIGHTING_MODULE_HH
...
namespace mikoto::renderer {
    ...
    class IndirectLightingModule final {
    public:
        explicit IndirectLightingModule( rhi::RenderResolution resolution );
...
#endif//MIKOTO_INDIRECT_LIGHTING_MODULE_HH
