...
namespace mikoto::renderer::vulkan {
    ...
    struct VulkanQueueData {
        u32 FamilyIndex{};
        QueueOpSupportFlags mOpSupportFlags{};
    ...
    struct InstanceBuilder {
        ...
        auto SetAppVersion( u32 major, u32 minor, u32 patch ) -> InstanceBuilder&;
        auto SetApiVersion( u32 major, u32 minor, u32 patch ) -> InstanceBuilder&;
        auto SetEngineVersion( u32 major, u32 minor, u32 patch ) -> InstanceBuilder&;
        ...
        auto QuerySurfaceSupport( Window* window ) -> InstanceBuilder&;
