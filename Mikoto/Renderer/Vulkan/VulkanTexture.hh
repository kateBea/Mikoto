...
namespace Mikoto {
    ...
    */
    ...
    public:
        ...
        explicit VulkanTexture(VkImage externalImage, VkImageViewCreateInfo viewCreateInfo);

        MKT_NODISCARD auto GetImage() const -> VkImage;
        MKT_NODISCARD auto GetView() const -> VkImageView;
    ...
    public:
        ...
        MKT_NODISCARD auto GetImage( Size_T index ) -> VulkanTexture&;
        MKT_NODISCARD auto GetImage( Size_T index ) const -> const VulkanTexture&;
