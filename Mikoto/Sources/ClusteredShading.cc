...
//                 MKT_BEGIN_PROFILER_NAMED();
//
//                 b.CreateBuffer( "AABBGenComp_Clusters", BufferUsage::eStorage,
//                                 MKT_SIZEOF( Cluster ), m_NumClusters, ResourceUsageType::RESOURCE_USAGE_DYNAMIC );
//
//                 b.UseShader( "Resources/Shaders/slang/AABBGen_Comp.slang", ShaderStage::eCompute );
...
//                 MKT_BEGIN_PROFILER_NAMED();
//
//                 b.CreateBuffer( "LightCullingComp_LightsBuffer", BufferUsage::eStorage,
//                                 MKT_SIZEOF( ShaderLightTypeParams ), MAX_LIGHTS, ResourceUsageType::RESOURCE_USAGE_DYNAMIC );
//
//                 b.UseShader( "Resources/Shaders/slang/LightCulling_Comp.slang", ShaderStage::eCompute );
...
//
//                 b.UseShader( "Resources/Shaders/slang/Gbuffer_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/Gbuffer_Frag.slang", ShaderStage::eFragment );
//
...
//
//                 b.UseShader("Resources/Shaders/slang/ZPass_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader("Resources/Shaders/slang/ZPass_Frag.slang", ShaderStage::eFragment );
//
//                 GraphicsPipelineDescription graphicsDesc{
//                     .DepthTest{ true },
//                     .DepthWrite{ true },
...
//                     uboLight.ActiveLightType = static_cast<Int32>( LightType::eDirectional );
//
//                     break;
//                 }
//
...
//
//                     uboLight.ActiveLightType = static_cast<Int32>( LightType::ePoint );
//
//                     break;
//                 }
//
...
//
//                     uboLight.ActiveLightType = static_cast<Int32>( LightType::eSpot );
//
//                     break;
//                 }
//             }
