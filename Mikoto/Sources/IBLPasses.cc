...
//             .WrapU{ SamplerWrapMode::eClampToBorder },
//             .WrapV{ SamplerWrapMode::eClampToBorder },
//             .WrapW{ SamplerWrapMode::eClampToBorder },
...
//
//                 b.UseShader( "Resources/Shaders/slang/Irradiance_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/Irradiance_Frag.slang", ShaderStage::eFragment );
...
//
//                         m_IrradianceParameters.DeltaTheta = 0.5f * math::Constants::kPi / 64.0;
//                         m_IrradianceParameters.DeltaPhi = 2.0f * math::Constants::kPi / 180.0f;
//                         m_IrradianceParameters.MVP = glm::perspective( static_cast<float>( math::Constants::kPi / 2.0 ), 1.0f, 0.1f, 512.0f ) * s_Matrices[face];
//
...
//
//                 b.UseShader( "Resources/Shaders/slang/Prefilter_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/Prefilter_Frag.slang", ShaderStage::eFragment );
...
//                         ctx.SetScissor( 0, 0, viewPortWidth, viewPortHeight );
//
//                         m_PrefilterParameters.MVP = glm::perspective( static_cast<float>( math::Constants::kPi / 2.0 ), 1.0f, 0.1f, 512.0f ) * s_Matrices[face];
//
...
//
//                 b.UseShader( "Resources/Shaders/slang/BRDFLut_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/BRDFLut_Frag.slang", ShaderStage::eFragment );
//
...
//
//                 b.UseShader( "Resources/Shaders/slang/SkyboxGen_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/SkyboxGen_Frag.slang", ShaderStage::eFragment );
...
//
//                         m_SkyboxRenderParameters.MVP = glm::perspective( static_cast<float>( math::Constants::kPi / 2.0 ), 1.0f, 0.1f, 512.0f ) * s_Matrices[face];
...
//                 MKT_BEGIN_PROFILER_NAMED();
//
//                 b.UseShader( "Resources/Shaders/slang/Skybox_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/Skybox_Frag.slang", ShaderStage::eFragment );
//
...
//                 };
//
//                 b.UseShader( "Resources/Shaders/slang/PBR_Basic_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/PBR_Basic_Frag.slang", ShaderStage::eFragment );
...
//                     .EnableSampleRateShading{ true },
//                     .MSAA{ Multisampling::MSAA_X1 },
//                     .PipelineCullMode{ CullMode::CULL_BACK },// We probably need to organize models by material some (or handle models with diff mats somehow)
//                                                         // models like the just_a_girl require cull_back to be properly visualized
//                     .VertexAttributesSpec{},
//                     .ColorAttachmentFormats{ TextureFormat::RGBA16_FLOAT }, // Shading pass may emit High range values, adjusted later by tonemap pass
//                 };
//
//                 b.UseShader( "Resources/Shaders/slang/PBR_MetallicRoughness_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/PBR_MetallicRoughness_Frag.slang", ShaderStage::eFragment );
