...
namespace Mikoto {
    ...
    auto ImGuiVulkanBackend::RecordCommands( const VkCommandBuffer cmd, VulkanImage& currentSwapChainImage ) const -> void {
        ...
        currentSwapChainImage.SubmitLayoutTransition( VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, cmd );
        ...
        currentSwapChainImage.SubmitLayoutTransition( VK_IMAGE_LAYOUT_PRESENT_SRC_KHR, cmd );
