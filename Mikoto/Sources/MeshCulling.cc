...
//
//         CommandListHandle cmd{ m_Device->CreateCommandList( QueueType::eTransfer, false ) };
//         cmd->Begin();
//
...
//
//         const auto [itInsert, success]{ m_Allocations.try_emplace( node, *alloc ) };
//
...
//                 .WithUsage( BufferUsage::eStorage )
...
//         indirectBufferDesc
//                 .WithUsage( BufferUsage::eIndirect )
...
//
//                 // Create Buffers
//                 b.CreateBuffer( "MeshCulling_GeometryInfo", BufferUsage::eStorage,
//                                 MKT_SIZEOF( ShaderMesh ), MAX_RENDERABLE_ENTITIES, ResourceUsageType::RESOURCE_USAGE_DYNAMIC );
//
//                 b.CreateBuffer( "MeshCulling_MaterialsInfo", BufferUsage::eStorage,
//                                 MKT_SIZEOF( ShaderMaterial ), MAX_RENDERABLE_ENTITIES, ResourceUsageType::RESOURCE_USAGE_DYNAMIC );
//
//                 b.CreateBuffer( "MeshCulling_SkinningInfo", BufferUsage::eStorage,
//                                 MKT_SIZEOF( SkinningInfo ), MAX_SKINNED_MESHES, ResourceUsageType::RESOURCE_USAGE_DYNAMIC );
//
//                 // TODO:
//                 // MeshCulling_OpaqueGeometryInfo -> Opaque geometry
//                 // MeshCulling_TransparentGeometryInfo -> Transparent geometry
//
...
//
//                 if (meshComponent.HasArmature()) {
//                     geometry.HasArmature = MKT_SHADER_TRUE;
...
//                                 geometry.MatricesIndex = sm.GetAnimatorID();
//                                 m_ActiveFinalMatsIndices.emplace( geometry.MatricesIndex );
//                             }
//                         } else {
//                             // Does not have animations but has armature and can be deformed
//                         }
//                     }
//                 }
//
