...
//     auto DecodeUTF8( const std::string& ut8 ) -> std::vector<UInt32> {
//         std::vector<UInt32> codepoints{};
//
//         for ( Size i{}; i < ut8.size(); ) {
//             UInt32 cp{};
//
...
//                 MKT_BEGIN_PROFILER_NAMED();
//
//                 b.CreateBuffer( "MSDFTextPass_TextData", BufferUsage::eStorage,
//                     MKT_SIZEOF( TextRenderParams ), MAX_GLYPHS, ResourceUsageType::RESOURCE_USAGE_DYNAMIC );
//
//                 b.UseShader( "Resources/Shaders/slang/MSDFText_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/MSDFText_Frag.slang", ShaderStage::eFragment );
//
...
//
//                 // TODO
//                 // MeshCulling_HighlightedGeometryInfo -> Highlighted geometry (outlined geometry) ??
//             },
...
//
//                 b.UseShader( "Resources/Shaders/slang/ChromaticAberration_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/ChromaticAberration_Frag.slang", ShaderStage::eFragment );
//
...
//                 } );
//
//                 b.Write( "ChromaticAberration_ColorTarget", FrameResourceState::ShaderRead_GraphicsPipeline );
//
...
//     }
//
//     auto PostEffectsPass::RegisterBloom( FrameGraph& graph, GpuDevice* device ) -> void {
//         MKT_BEGIN_PROFILER_NAMED();
//
...
//
//                 b.UseShader( "Resources/Shaders/slang/Tonemap_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/Tonemap_Frag.slang", ShaderStage::eFragment );
//
...
//
//                 b.UseShader( "Resources/Shaders/slang/ColorGradient_Vert.slang", ShaderStage::eVertex );
//                 b.UseShader( "Resources/Shaders/slang/ColorGradient_Frag.slang", ShaderStage::eFragment );
//
...
//                 } );
//
//                 b.Write( "ColorGradient_ColorTarget", FrameResourceState::RenderTarget );
//
//                 b.Read( "3DRenderTextEdge", FrameResourceState::UniformBuffer );
//                 b.Read( "FinalShadingPass_BufferEDGE+", FrameResourceState::UniformBuffer );
//                 b.Read( "FinalShadingPass_ColorTarget", FrameResourceState::ShaderRead_GraphicsPipeline );
...
//
//         auto decoded{ DecodeUTF8(textComponent.GetContents()) };
//
//         for ( const auto& character: decoded /*textComponent.GetContents()*/ ) {
//             bool isLineFeed{ character == static_cast<UInt32>( U'\n' ) || IsLineFeed( character ) };
//
//             if ( isLineFeed ) {
//                 xPos = position.x;
//                 yPos += lineHeight;
