...
//
//         m_Registry.on_construct<TextComponent>().connect<&Scene::OnTextComponentAttach>( this );
//         m_Registry.on_construct<RenderComponent>().connect<&Scene::OnRenderComponentAttach>( this );
//         m_Registry.on_construct<RigidBodyComponent>().connect<&Scene::OnRigidBodyComponentAttach>( this );
//     }
//
