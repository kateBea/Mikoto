...
//
// namespace Mikoto {
//     VulkanFramebuffer::VulkanFramebuffer( const VulkanFramebufferDescription &createInfo )
...
//     }
//
//     auto VulkanFramebuffer::Create( const VulkanFramebufferDescription &createInfo ) -> Scope_T<VulkanFramebuffer> {
